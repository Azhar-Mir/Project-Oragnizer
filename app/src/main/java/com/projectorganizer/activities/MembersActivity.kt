...
import com.projectorganizer.adapters.MemberListItemsAdapter
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
            ...
            try {
                ...
                dataObject.put(Constants.FCM_KEY_TITLE, "Assigned to the Workspace $boardName")

                dataObject.put(
                    Constants.FCM_KEY_MESSAGE,
                    "You have been assigned to the new workspace by ${mAssignedMembersList[0].name}"
                )
