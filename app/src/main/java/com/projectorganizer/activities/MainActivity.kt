...
import com.projectorganizer.adapters.BoardItemsAdapter
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences = this.getSharedPreferences(Constants.PROJECTORGANIZER_PREFERENCES, Context.MODE_PRIVATE)
